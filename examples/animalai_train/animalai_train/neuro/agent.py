...
class DQN:
    ...
    def __init__(self, cfg):
        ...
        self.q_network = Network(input_dimension=4, output_dimension=6)
        # Create target network
        self.t_network = Network(input_dimension=4, output_dimension=6)
...
class Agent:
    ...
    def process_state_action(self, next_state, reward, done):
        ...
        # Create a transition
        transition = (self.state, self.action, reward, features)
