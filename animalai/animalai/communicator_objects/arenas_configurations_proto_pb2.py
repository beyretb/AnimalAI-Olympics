...
from animalai.communicator_objects import arena_configuration_proto_pb2 as animalai_dot_communicator__objects_dot_arena__configuration__proto__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[animalai_dot_communicator__objects_dot_arena__configuration__proto__pb2.DESCRIPTOR,])
...
_ARENASCONFIGURATIONSPROTO_ARENASENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='communicator_objects.ArenasConfigurationsProto.ArenasEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='communicator_objects.ArenasConfigurationsProto.ArenasEntry.value', index=1,
...
_ARENASCONFIGURATIONSPROTO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='arenas', full_name='communicator_objects.ArenasConfigurationsProto.arenas', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='seed', full_name='communicator_objects.ArenasConfigurationsProto.seed', index=1,
...
_ARENASCONFIGURATIONSPROTO_ARENASENTRY.fields_by_name['value'].message_type = animalai_dot_communicator__objects_dot_arena__configuration__proto__pb2._ARENACONFIGURATIONPROTO
_ARENASCONFIGURATIONSPROTO_ARENASENTRY.containing_type = _ARENASCONFIGURATIONSPROTO
_ARENASCONFIGURATIONSPROTO.fields_by_name['arenas'].message_type = _ARENASCONFIGURATIONSPROTO_ARENASENTRY
DESCRIPTOR.message_types_by_name['ArenasConfigurationsProto'] = _ARENASCONFIGURATIONSPROTO
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ArenasConfigurationsProto = _reflection.GeneratedProtocolMessageType('ArenasConfigurationsProto', (_message.Message,), dict(
...
_ARENASCONFIGURATIONSPROTO_ARENASENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
